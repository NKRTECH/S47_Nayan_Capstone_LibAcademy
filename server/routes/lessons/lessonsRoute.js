...
const {getLessonsByCourseIdController, getLessonsByCourseIdTutorController} = require('../../controllers/lessons/getLessonsByCourseIdController');
...
router.get('/fetchLessonsByCourseId/:courseId', getLessonsByCourseIdTutorController);
