...
// import { useNavigate, useParams } from 'react-router-dom';
// import axios from 'axios';
// import { Box, Button, Card, CardContent, Typography, Grid, Alert, Container } from '@mui/material';
// import { styled } from '@mui/material/styles';
...
//   return (
//     <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: '#f4f4f4' }}>
//       <Container sx={{ flexGrow: 1, paddingTop: '16px', paddingBottom: '16px' }}>
//         <Typography variant="h4" gutterBottom>
//           Course Lessons
//         </Typography>
//         <Box sx={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '16px' }}>
//           <CreateLessonButton variant="contained" onClick={() => navigate(`/tutor/courses/${courseId}/createlesson`)}>
//             Create Lesson
//           </CreateLessonButton>
//         </Box>
//         {error && <Alert severity="error">{error}</Alert>}
...
//           {lessons.lessons?.map((lesson) => (
//             <Grid item xs={12} sm={6} md={4} key={lesson._id}>
//               <Card sx={{ cursor: 'pointer', height: '100%' }} onClick={() => handleLessonClick(lesson._id)}>
//                 <CardContent>
//                   <Typography variant="h6" gutterBottom>
//                     {lesson.title}
//                   </Typography>
//                   <EditButton variant="contained" onClick={(event) => handleEditClick(event, lesson._id)}>
//                     Edit
//                   </EditButton>
//                 </CardContent>
//               </Card>
